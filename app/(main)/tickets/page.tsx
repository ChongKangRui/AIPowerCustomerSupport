...
//
// TicketsView reads page/sort state via next/navigation's useSearchParams(),
// which Next.js requires to sit under a Suspense boundary. The fallback
// reuses TicketsView's own loading skeleton so this doesn't change the
// loading UX, just satisfies the boundary requirement.
